...
// This task's main product is the STATE in GET /v1/estado (estado.go),
...
// mechanism.
//
// SAME MOLD AS Watchdog (vigia.go): a timer measures/acts per instance,
...
// (vigia.go), but for the INSTAGRAM token instead of the WhatsApp
// acceptance verdict.
...
// attempt. It's what GET /v1/estado (estado.go, via
