...
func MetaBody(p Request) map[string]any {
	...
	case "pedir_localizacao":
		...
		// case "pedir_localizacao", in mensagem.go).
		body["type"] = "interactive"
	...
	case "flow":
		...
		// — see the FlowRequest comment in mensagem.go for the whole
		...
		//
		// Validate() (mensagem.go, validateFlow) already guaranteed: Flow != nil;
	...
	case "contatos":
		...
		// in mensagem.go, for why) — there is no field-by-field assembly
