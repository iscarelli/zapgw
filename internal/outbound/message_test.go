...
// F4 — found in the adversarial re-review. message.go called meta.Canonicalize(p.To)
...
// in message.go and docs/ARMADILHAS.md)
// ---------------------------------------------------------------------------
...
// quickReplyButtonCountLimit in message.go): four buttons sent
...
// limits in message.go for why the provenance matters.
// ---------------------------------------------------------------------------
...
// message.go). It's the decision recorded in T-143: the gateway doesn't
...
// default) -- see the comment on FlowRequest in message.go. With the
