...
// the "flow" case of MetaBody (body.go).
//
...
// on FlowRequest, in message.go). Only a real call against Meta fixes this
...
// body of `tipo:"flow"` (T-154, see MetaBody in body.go) — NOT A
