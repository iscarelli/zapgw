...
// suite for each route (health_handler_test.go, reads_handler_test.go,
// media_handler_test.go, templates_handler_test.go, registration_handler_test.go)
...
// T-115 (2): the `default:` branch of accepts (types.go) — the fail-closed
