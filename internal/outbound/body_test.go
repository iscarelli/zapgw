...
// purpose -- see the comment on the Contact type in message.go -- so this
...
// TestValidateAcceptsLocationRequestWithLongText (message_test.go). Here it
...
// body.go and the comment on FlowRequest in message.go. Compared by WHOLE
