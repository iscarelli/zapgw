...
// CounterReadsMarked (internal/config/contador.go) had already flagged this
...
// on our dashboard (see CounterBillingOther, in internal/config/contador.go).
...
func (a *unknownCategoryWarning) warn(slug, category string) {
	...
	log.Printf("ALARME zapgw: instancia %q recebeu cobranca da Meta na categoria %q,"+
		...
		" ACAO: acrescentar a chave em internal/config/contador.go (ela aparece sozinha em"+
