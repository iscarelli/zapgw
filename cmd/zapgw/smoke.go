...
// (internal/outbound/smoke.go) — the SAME function that `POST /v1/fumaca`
// calls (internal/outbound/smoke_handler.go, T-084). This file only does
...
// TestSmokeWithSendFailureLEAVESTheInstancePAUSED (smoke_test.go) —
