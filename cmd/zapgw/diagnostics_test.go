...
// internal/meta/instagram_diagnostics_test.go, repeated here because this
...
// branch (`default` in cmd/zapgw/diagnostics.go) — the warning that
...
// (internal/meta/instagram_diagnostics.go) — unexported, so the `main`
