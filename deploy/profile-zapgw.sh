...
#   2. an interactive shell does not inherit systemd's env, so ZAPGW_DATABASE and
#      ZAPGW_ENCRYPTION_KEY are missing. Symptom: the menu opens and prints
...
# including ZAPGW_ENCRYPTION_KEY — alive only for the duration of the call. With
